...
namespace SmartSchool.WebAPI.Data
{
    ...
    {
        internal IQueryable<Aluno> alunos;


        public SmartContext(DbContextOptions<SmartContext> op) : base(op)
        {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    new Aluno(1, 0001 ,"Marta", "Kent", "33225555",DateTime.Parse("05/28/2005",CultureInfo.InvariantCulture)),
                    new Aluno(2, 0002 ,"Paula", "Isabela", "3354288", DateTime.Parse("05/28/2005",CultureInfo.InvariantCulture)),
                    new Aluno(3, 0003 ,"Laura", "Antonia", "55668899",DateTime.Parse("05/28/2005",CultureInfo.InvariantCulture)),
                    new Aluno(4, 0004 ,"Luiza", "Maria", "6565659",DateTime.Parse("05/28/2005",CultureInfo.InvariantCulture)),
                    new Aluno(5, 0005 ,"Lucas", "Machado", "565685415",DateTime.Parse("05/28/2005",CultureInfo.InvariantCulture)),
                    new Aluno(6, 0006 ,"Pedro", "Alvares", "456454545",DateTime.Parse("05/28/2005",CultureInfo.InvariantCulture)),
                    new Aluno(7, 0007 ,"Paulo", "José", "9874512",DateTime.Parse("05/28/2005",CultureInfo.InvariantCulture)),
                });
